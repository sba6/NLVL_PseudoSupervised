...
from datasets.charades_eval import eval_props
...
def get_args_parser():
    ...
    parser.add_argument('--feature_path',
                        default='data/thumos14_I3D_features',
                        type=str)
    parser.add_argument('--tem_path', default='data/thumos14_TEM_scores', type=str)
...
def main(args):
    ...
    if args.eval:
        dataset_val = build_dataset(image_set='all', args=args)
    else:
