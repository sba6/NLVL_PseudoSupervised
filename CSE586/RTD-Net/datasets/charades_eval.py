...
def average_recall_vs_nr_proposals(proposals,
    ...
    for videoid in video_lst:
        ...
        # Video Proposals
        vals = proposals[proposals['video-name']==videoid]
        vals.sort_values('score',ascending=False, inplace=True)
...
def formatting(results):
    results_list = []
    frame_dict = load_json('datasets/charades_frames_info.json')
...
def eval_props(results):
    ...
    ground_truth = pd.read_csv('datasets/charades_ground_truth.csv')
